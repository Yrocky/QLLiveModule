...
@interface UIImage (QLLiveModule)

- (UIImage *) QLLiveModule_imageByRoundCornerRadius:(CGFloat)radius;
...
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)layoutAttributes{
    ...
    if ([layoutAttributes isKindOfClass:[QLLiveDecorateSectionLayoutAttributes class]]) {
        ...
        if (contents.isColor) {
            ...
            self.layer.contents = (__bridge id)[contents.image QLLiveModule_imageByRoundCornerRadius:builder.radius].CGImage;
...
@implementation UIImage (QLLiveModule)


- (UIImage *)QLLiveModule_imageByRoundCornerRadius:(CGFloat)radius {
    return [self QLLiveModule_imageByRoundCornerRadius:radius borderWidth:0 borderColor:nil];
}

- (UIImage *)QLLiveModule_imageByRoundCornerRadius:(CGFloat)radius
                          borderWidth:(CGFloat)borderWidth
                          borderColor:(UIColor *)borderColor {
    return [self QLLiveModule_imageByRoundCornerRadius:radius
